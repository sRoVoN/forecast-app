...
function AppPlay() {
  ...
  const getWeather = async (lat, lon) => {
    const url = `https://api.openweathermap.org/data/2.5/forecast?lat=${lat}&lon=${lon}&appid=ad1638d70d18524d5c67056b3e47f843&units=metric`;
    ...
    try {
      ...
      if (data.list[0].main) {
        ...
        setWeatherData({
          ...
          feelsLike: Math.floor(data.list[0].main.feels_like),
